...
- <s>Fix project so when u 'npm install' it doesn't break and say some vc++ error
- Add Releases so you can just get a distribution player instead of a whole package you need to compile yourself everytime</s>
